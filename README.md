...
2. Open `ChuenBank-main` and click the `chuenbank.exe` file.
3. Have fun!
...
ChuenBank is open-source software released under the [MIT License](https://github.com/MemeChuen/ChuenBank-V1/blob/main/LICENSE).
